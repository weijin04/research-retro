...
from research_harness.reconstruction.audit import CHECKS, case_path, execute_check, integrate_case, revoke
...
from research_harness.decisions.workflow import attach_advice
...
def main(argv=None):
    ...
    p.add_argument("--project", default=str(ROOT / "config/grephene.json"))
