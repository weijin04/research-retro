...
This repository owns the standalone Research Retro 2.0 reconstruction product. Historical implementation plans remain at the root; the shipped engine is `src/research_harness/`.
